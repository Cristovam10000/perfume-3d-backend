...
- Se `/sales/snapshot` falhar, o app continua com dados locais/mockados; isso e comportamento esperado do `SalesController` (fonte: `../perfume-3d-frontend/lib/features/sales/data/sales_repository.dart`).
